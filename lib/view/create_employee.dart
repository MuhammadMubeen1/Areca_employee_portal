...
Future<void> _createEmployee() async {
  ...
  // Extract results
  final String? imageUrl = uploadResults[0];
  final String? fileUrl = pickedFile != null ? uploadResults[1] : null;
  final String? imageUrl2 = pickedFile != null ? uploadResults[pickedFile != null ? 2 : 1] : uploadResults[2];
  final String? fileUrl2 = pickedFile2 != null ? uploadResults[pickedFile != null ? 3 : 2] : null;
  final String? imageUrl3 = pickedFile2 != null ? uploadResults[pickedFile2 != null ? 4 : 3] : uploadResults[4];
  final String? fileUrl3 = pickedFile3 != null ? uploadResults[pickedFile2 != null ? 5 : 4] : null;

  int id = DateTime.now().millisecondsSinceEpoch;
  String currentDate = DateFormat('yyyy-MM-dd').format(DateTime.now());

  // Add the employee data to Firestore
  await FirebaseFirestore.instance.collection('All Employees').add({
